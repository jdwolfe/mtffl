...
Last Modified: 2017-08-27 <a href="rule-amendments/#update20170827">?</a></p>
...
<ol>
	...
	<li>
		...
		<ol>
			...
			<li>
				<div>
					In each weekly contest one team is designated as the Home Team. <span class="rule-change-strike">which receives a 7-point bonus referred to as Home Field Advantage (HFA). <a href="rule-amendments/#amendment6">amendment #6</a></span> <a href="rule-amendments/#amendment12">amendment #12</a>
				</div>
			</li>
	...
	<li>
		...
		<ol>
			...
			<li>
				<span class="rule-change-strike">The team with the lowest seed number will have HFA.</span>
			</li>
			...
			<li>
				<span class="rule-change-strike">All second round playoff games will be played on 'neutral' fields and will be exempt from the Home Field Advantage (HFA) rule. <a href="rule-amendments/#amendment7">amendment #7</a></span>
			</li>
	...
	<li>
		...
		<ol>
			<li>
				Each team's roster may contain up to 24 players <a href="rule-amendments/#amendment11">amendment #10</a> including quarterbacks (QB), running backs (RB), wide receivers (WR), tight ends (TE), place kickers (K), defensive linemen (DL), linebackers (LB) and defensive backs (DB).
			</li>
	...
	<li>
		...
		<ol>
			...
			<li>
				<div>Because of a <a href="http://mtffl.com/smackroom/viewtopic.php?f=1&t=2349">bug</a> we found in the MyFantasyLeague.com software, we now use their official formations as the only valid lineups.<br>
                We allow:
				<ul>
	...
	<li>
		...
		<ol>
			<li>All Players are locked at the start of their game. <a href="rule-amendments/#amendment14">amendment #14</a></li>
			<li class="rule-change-strike">Starting Lineups are to be submitted before the start of the first game of the NFL week.</li>

			<li class="rule-change-strike">NOTE: In the case of Early Games (meaning non-Sunday games), teams may submit a partial lineup containing the NFL teams playing Early Games. These players can not be removed from the starting lineup after the game has started. Other players from the NFL teams Early Games can not be added after the Early Games start. Players on other NFL teams may be moved as normal.</li>
		</ol>
	</li>
	...
	<li>
		...
		<ol>
			<li>Points are awarded using this <a href="scoring-rules/">Scoring Formula</a>. <a href="rule-amendments/#amendment3">amendment #3</a> <a href="rule-amendments/#amendment13">amendment #13</a> <a href="rule-amendments/#amendment15">amendment #15</a></li>
			...
			<li><span class="rule-change-strike">The home team will receive a 7 point bonus known as the Home Field Advantage (HFA) rule.</span> <a href="rule-amendments/#amendment6">amendment #6</a> <a href="rule-amendments/#amendment12">amendment #12</a></li>
		</ol>
	</li>
	...
	<li>
		...
		<ol>
			...
			<li>Suspended Players are not eligible for IR.</li>
		</ol>
	</li>
